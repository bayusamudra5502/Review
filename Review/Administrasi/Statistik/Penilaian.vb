...
Public Class Penilaian
	...
	Private Async Sub Loads(sender As Object, e As EventArgs) Handles MyBase.Load
	...
	Private Async Function Refreshs() As Task(Of Boolean)
		...
		Try
			...
			Dim adapter As New NpgsqlDataAdapter(String.Format("SELECT {0}ID_Kesan{0},{0}Nama{0},{0}Kelas{0},{0}Penilaian{0},{0}Kesan{0} FROM public.{0}Kesan{0};", Chr(34)), Koneksi)
